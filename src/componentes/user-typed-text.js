...
export const UserTypedText = ({ text, short, noWrap, style={} })=> {
    ...
    return <div style={{ display:"inline", fontFamily:"'Azeret Mono', monospace",whiteSpace: noWrap? "nowrap" : "pre-wrap", wordBreak:"normal", wordWrap:"break-word", ...style }}>{ short? shortText(text) : text }</div>;
}